	...
	if(message.channel.id == transfer_room) {
		...
		if(message.author.id == probot) {
			if(message.content.includes("has transferred")) {
				...
				if(!line) line = `https://media.discordapp.net/attachments/1133351211656036442/1194955034354524180/Picsart_23-12-28_09-55-22-159.jpg?ex=65b23b99&is=659fc699&hm=bf46f04ad4a2845378c0dce28bff4448d72d192cf4d8fe7ed15db9a04f2e7cfc&`
